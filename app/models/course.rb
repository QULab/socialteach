...
class Course < ActiveRecord::Base
  ...
  has_one :user, as: :creator
   ...
   ##
   # Throws an error if one or more users are enrolled in a course to be unpublished.
   ...
   ##
   # Creates a default feedback questionnaire for the course.
   ...
   ##
   # Creates a default chapter containing a default assessment for a course.
