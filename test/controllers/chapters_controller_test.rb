...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { description: @chapter.description, name: @chapter.name, shortname: @chapter.shortname }
    end
  ...
  test "should update chapter" do
    patch :update, id: @chapter, chapter: { description: @chapter.description, name: @chapter.name, shortname: @chapter.shortname }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
