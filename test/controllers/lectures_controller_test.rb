...
class LecturesControllerTest < ActionController::TestCase
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post :create, lecture: { course_id: @lecture.course_id, description: @lecture.description, name: @lecture.name }
    end
  ...
  test "should update lecture" do
    patch :update, id: @lecture, lecture: { course_id: @lecture.course_id, description: @lecture.description, name: @lecture.name }
    assert_redirected_to lecture_path(assigns(:lecture))
  end
